...
function initSprites(img) {
	...
	s_bird = [
		...
		new Sprite(img, 175, 115, 17, 13),
		new Sprite(img, 175, 129, 17, 16),
		new Sprite(img, 175, 144, 17, 16),
		new Sprite(img, 192, 115, 17, 12),
		new Sprite(img, 192, 128, 17, 12),
		new Sprite(img, 192, 142, 17, 12)
	];
	
	s_bg = new Sprite(img,   0, 0, 138, 114);
	s_bg.color = "#C1A8D0"; // save background color
	s_fg = new Sprite(img, 138, 0, 112,  56);
	
	s_pipeNorth = new Sprite(img, 252, 75, 26, 130);
	s_pipeSouth = new Sprite(img, 277, 0, 26, 117);
